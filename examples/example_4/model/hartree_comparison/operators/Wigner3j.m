...
% Validate integer, parity, triangle, and magnetic-index constraints.
...
if j3 > j1 + j2 || j3 < abs(j1 - j2)
    % The triangle condition gives a zero symbol.
    wigner=0;
    return;
end
...
if m1+m2+m3~=0
    % A nonzero magnetic-index sum gives a zero symbol.
    wigner=0;
    return;
end
