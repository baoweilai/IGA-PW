...
% Set paths and enter the Example 3 data directory.
...
switch string(workflowName)
    ...
    case "method_comparison"
        ...
        resultDir = fullfile(exampleDir, 'data', 'method_comparison');
        run_method_data(resultDir);
        plot_method_fields(resultDir);
