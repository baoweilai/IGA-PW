function [P, S] = IGA_DG_Left_Edge_Assemble( ...
nurbs_original, nurbs_refine, pw_index, plane_wave_dofs_index, L, n_dofs)
% Assemble DG interface matrices on the left edge:
%   P : jump-jump term
%   S : jump-average term
...
%% Parametric intervals of left edges
...
for e = 1:vNoEs
    ...
    for i = 1:n_gp
        ...
        [F, DF_plus] = NurbsSurface( ...
            ConPts_o, weights_o, knotU_o, pu_o, u_left_inner, knotV_o, pv_o, v);
        ...
        Nu_plus    = Uders_plus(1, 1:2)';
        DNu_plus   = Uders_plus(2, 1:2)';
