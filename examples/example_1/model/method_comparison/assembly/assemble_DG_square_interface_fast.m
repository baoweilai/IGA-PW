...
[Pedge, Sedge, Pmm, Smm, edgeMetaBottom] = assemble_horizontal_edge_local( ...
    ...
    nurbs_refine.bottom_dofs_2_layers, -a, [0; -1], ...
...
[Pedge, Sedge, Pmm, Smm, edgeMetaTop] = assemble_horizontal_edge_local( ...
    ...
    nurbs_refine.top_dofs_2_layers, a, [0; 1], ...
    pwx, pwy, alpha, Omega_area, a, inv_df, Kx);
...
[Pedge, Sedge, Pmm, Smm, edgeMetaLeft] = assemble_vertical_edge_local( ...
    ...
    nurbs_refine.left_dofs_2_layers, -a, [-1; 0], ...
...
[Pedge, Sedge, Pmm, Smm, edgeMetaRight] = assemble_vertical_edge_local( ...
    ...
    nurbs_refine.right_dofs_2_layers, a, [1; 0], ...
    pwx, pwy, alpha, Omega_area, a, inv_df, Ky);
...
for e = 1:n_elem
    ...
    for i = 1:n_gp
        ...
        du_part = (dnvar * fixed_vals);
        dv_part = (nvar * fixed_ders);
        grad_plus = [du_part(:), dv_part(:)] * inv_df;
        avg_plus = (grad_plus * normal / 2).';
...
for e = 1:n_elem
    ...
    for i = 1:n_gp
        ...
        du_part = fixed_ders * nvar;
        dv_part = fixed_vals * dnvar;
        grad_plus = [du_part(:), dv_part(:)] * inv_df;
        avg_plus = (grad_plus * normal / 2).';
