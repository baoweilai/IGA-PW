...
assert(isfield(opts, 'inner_quad_n'), 'Missing opts.inner_quad_n.');
...
inner_quad_n = opts.inner_quad_n;
...
[VinInner, chebInfo] = build_inner_chebyshev_correction_2D( ...
    L, inner_domains, qvals, inner_cheb_n, inner_quad_n, sample_fun);
